...
setup(
    ...
    entry_points={
        ...
        'fanstatic.libraries': [
            'stylesheets = adhocracy_client.static:stylesheets_library',
            'yaml = adhocracy_client.static:yaml_library',
            'autocomplete = adhocracy_client.static:autocomplete_library',
            'placeholder = adhocracy_client.static:placeholder_library',
            'jquerytools = adhocracy_client.static:jquerytools_library',
            'knockout = adhocracy_client.static:knockout_library',
            'misc = adhocracy_client.static:misc_library',
            'adhocracy = adhocracy_client.static:adhocracy_library',
            'bootstrap = adhocracy_client.static:bootstrap_library',
        ],
        'nose.plugins': [
